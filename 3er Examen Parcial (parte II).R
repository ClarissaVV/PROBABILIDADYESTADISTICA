...
# 3er Examen parcial. (parte II) Distribució Normal
...
# una desviación estándar de 100. Timmy quiere ser admitido en esta universidad y 
...
# y una desviación estándar de 100. Tú quieres ser admitido en esta institución 
...
# Prueba de hipótesis / T-test / Ejercicio (Replica)
set.seed(10)
